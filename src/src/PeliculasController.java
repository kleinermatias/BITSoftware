...
public class PeliculasController {
	...
	public PeliculasController(PeliculasView ui, Ticket ticket) {
		this.modelo=PeliculasModel.getInstance();
		PeliculasModel modelo2=PeliculasModel.getInstance(); //Probamos que verdaderamente hay un singleton Model
		this.ticket = ticket;
		this.ui = ui;
		try {
			this.modelo.readData();
			this.movies = modelo.getAllMovies();
			addMovieList(movies);
		} catch (Exception e) {
